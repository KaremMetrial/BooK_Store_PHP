                            ...
                            <table class="table" height="190">
                                ...
                                <?php foreach ($products as $product): ?>
                                    <tr class="mb-4">
                                        ...
                                        <td><input id="form1" min="1" name="quantity" value="1" type="number" class="form-control form-control-sm pro_amount" /></td>
                                        <td class="total_price">$<?= $product['product_price']; ?></td>
                    ...
                    <div class="col-lg-4 bg-grey">
                        <div class="p-5">
                            ...
                            <div class="d-flex justify-content-between mb-5">
                                ...
                                <h5 class="summary_total_price">€ 137.00</h5>
                            </div>
